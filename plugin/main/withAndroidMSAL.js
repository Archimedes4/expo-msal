...
exports.withAndroidMSAL = exports.withAndroidActivity = void 0;
            ...
            data: [
                {
                    $: {
                        ...
                        'android:path': ``, //TODO /${signatureHash}
                    },
                },
            ],
        },
...
const withAndroidMSAL = (config, androidPackageSignatureHash) => {
    return (0, config_plugins_1.withPlugins)(config, [[exports.withAndroidActivity, androidPackageSignatureHash], withAndroidMSALGradle]);
};
exports.withAndroidMSAL = withAndroidMSAL;
